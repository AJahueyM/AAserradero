export const esMx = {
  translation: {
    ...
    clients: {
      modeLabel: 'Seleccionar o crear cliente',
      existing: 'Cliente existente',
      new: 'Nuevo cliente',
      searchLabel: 'Buscar por nombre',
      searchHint: 'Escribe para buscar clientes',
      noResults: 'Sin coincidencias',
      vipFilter: 'Solo clientes VIP',
      vip: 'VIP',
      blacklisted: 'Lista negra',
      blacklistWarning: 'Cliente en lista negra: {{reason}}',
      recentActivity: 'Actividad reciente: {{count}} reservación(es) en el último año',
      name: 'Nombre',
      cellphone: 'Celular',
      phone: 'Teléfono',
